...
function App() {
  ...
  async function loadReportsWorkspace() {
    ...
    try {
      ...
      const reportExports = await fetchPlanningRunExports(planningRun.id);
      if (reportsViewRequestId !== reportsViewRequestIdRef.current) {
        return;
      }
      ...
      setReportsViewState({
        status: "ready",
        planningRun,
        generatedExports: latestExportsByReportType(reportExports.items),
                ...
                <section className="validation-section report-card" key={report.reportType}>
                  ...
                  {exportRecord ? (
                    <dl className="summary-grid">
                      ...
                      <div>
                        <dt>Generated by</dt>
                        <dd>{exportRecord.generated_by_user_display_name ?? exportRecord.generated_by_user_id}</dd>
                      </div>
                      <div>
                        <dt>Sheets</dt>
